...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  when others do the same for your code?
    - ANSWER: 
        Code readability is the most important part of code reviews for me. I need to be able to read someone elses code to
        efficiently evaluate and understand the code. This includes style and comments. If things are straightforward then 
        an explanation is unnecessary, but there should be a comment explaining the purpose and use when creating a new function. 

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?
    - ANSWER:
        Containers allow different users to access specific libraries and packages depending on the current task he/she is 
        working on. For example, maybe Acme's QA team only needs to use numpy in order to effectively do their job, while 
        Acme's Strategy team needs lots of data visualization and manipulation packages. If we create containers we save time and 
        computing power by having each individual use the minimum necessary resources to do their job well.
